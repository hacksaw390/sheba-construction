        ...
        <div class="row">
            <div class="col-md-8 m-auto">
                <div class="card">
                    <div class="card-body">
                    <!-- Default form login -->
                        <form action="{{route('store')}}" method="post" class="border border-light p-5">
                            @csrf

                            <p class="h4 mb-4 text-center">Add Service Item</p>

                            <!-- title -->

                            <div class="form-group">
                                <label for="title">Title</label>
                                <input type="text"  name="title" value="{{old('title')}}" id="title" placeholder="Title" class="form-control mb-4">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="icon" value="{{old('icon')}}" id="title" placeholder="Choose Font Awesome Icon" class="form-control mb-4">
                            </div>
